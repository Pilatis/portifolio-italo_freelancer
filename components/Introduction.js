    ...
    >
      ...
      >
        <Text color="textSecondary" fontSize="display3">
          {introduction[0].emoji} {introduction[0].description}
          <br />
          <Stack isInline spacing={1}>
            <Box>{introduction[1].emoji}</Box>
            <Box>
              {introduction[1].description}{' '}
              {introduction[1].companyUrl ? (
                <Link
                  href={introduction[1].companyUrl}
                  isExternal
                  onClick={() => handleClick('Introduction_companyUrl')}
                  rel="noreferrer"
                >
                  {introduction[1].company}
                </Link>
              ) : (
      ...
      >
        <Stack isInline spacing={4}>
          <Link href="https://github.com/italosantana" isExternal>
            <Button
              pos="static"
              color="white"
          ...
          <Link href="https://linkedin.com/in/italosantana" isExternal>
            <Button
              pos="static"
              color="white"
          ...
          <Link href="mailto:italo.santana.peronsal@gmail.com" isExternal>
            <Button
              pos="static"
              color="white"
              transition="0.3s"
